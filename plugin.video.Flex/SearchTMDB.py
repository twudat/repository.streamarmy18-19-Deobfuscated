...
Addon_Image = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'icon.png'))
...
def passed(self, title):
    ...
    if 'MOVIE' in source:
        try:
            ...
            dialog.notification(
                AddonTitle, '[COLOR red]End Of Results, Or TMDB Not Responding[/COLOR]', Addon_Image, 5000)
            quit()
        for info in movies:
